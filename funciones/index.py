...
print('Bienvenido. Este programa permite sacar raices cuadradas. \nEstas son las opciones para sacar tu raiz: \n - Ingresa 1 para la Enumeracion Exahustiva.\n - Ingresa 2 para la Aproximacion epsilon. \n - Ingresa 3 para la Busqueda Binaria.')
